...
| 0:45–0:59 | 14s | Enter the README Usage task, add immutable context from `+`, cycle Reasoning once, then send. Briefly show the independent Fast, Goals, and Plan flags without enabling unneeded modes. | “I ask it to update the README, run a relevant check, and commit. Coding Wife sends the instruction with a versioned, validated context snapshot, never generic shell access from the WebView.” |
...
| Locked dependency inventory | `third-party/THIRD-PARTY-DEPENDENCIES.json` (438,145 bytes) | `dfce969b0059c0414456dca4b3f0361a9430aa4763c3acd464148052ff55a980`; pnpm lock `9b1a5f60b855c508dbda15a2066bc1123484d6a067706d5ec3927946fb929ae4`; Cargo lock `6e9f0afbd74299b9f6f11f4f23661536ff25ef16f675f06b2f3eb95ec29d28de` | Repository and packaged app resources | Generated and verified: npm production closure 395, effective Cargo normal graph 235, unknown/forbidden/missing 0 |
| Locked dependency notice | `third-party/THIRD-PARTY-DEPENDENCIES.md` (970,796 bytes) | `36b334d6a1505759896a150a4542cf77758f736d91521eb633486520b5dfbe32` | Repository and packaged app resources | Generated and verified; Cargo identities and SPDX grammar fail closed, and the npm closure is conservative package-manager classification rather than bundle attribution |
