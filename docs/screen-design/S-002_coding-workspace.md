...
| 通常 | connected、turnなし、decisionなし | timeline、enabled composer、idle character | send、inspect、read-only context snapshot、Chat/Commit/Settings tab移動 | send、offline、error |
