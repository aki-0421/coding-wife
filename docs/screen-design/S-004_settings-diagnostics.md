...
| Codex         | executable、protocol initialize、login、`GPT-5.6 Sol`、広告済みreasoning effort、Fast service tier capability                                                                               | missing、unauthenticated、model/effort unavailable、disconnect                                          | Recheck、login案内                                  |
