...
| `NARR-F-085` | cancelとselection変更は字幕・音声を同じgenerationで停止する       | Cancel、別commit選択、workspace切替、stale workspace generationの各場合にpresentation generationを進め、旧keyのcaption/live regionをterminal化し、active/queued speechを100ms以内に停止して後着chunkを破棄する                                                       | Approved | 非該当           |
...
| ------- | -------------------------- | ---------------------------------------------------------------------------------- | ---- | -------------------------------------------------------------- |
| `S-002` | コーディングワークスペース | `NARR-F-057`〜`NARR-F-063`, `NARR-F-068`〜`NARR-F-075`, `NARR-F-078`〜`NARR-F-087` | 変更 | [画面詳細仕様](../screen-design/S-002_coding-workspace.md)     |
| `S-003` | セッション証拠             | `NARR-F-078`〜`NARR-F-087`                                                         | 変更 | [画面詳細仕様](../screen-design/S-003_session-evidence.md)     |
