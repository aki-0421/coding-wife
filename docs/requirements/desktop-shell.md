...
| `APP-F-066` | 利用者はofflineでもlocal evidenceを確認できる | networkまたはCodex接続がない時もworkspace、timeline、Commit、App SettingsのProject / Character contextを開け、送信だけを理由付きで無効にする | Approved | 非該当 |
