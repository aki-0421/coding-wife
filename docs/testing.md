...
Do not reuse or move an existing tag. The version-tag workflow creates or refreshes a draft named `Coding Wife v0.1.2` with exactly these assets:

```text
Coding-Wife-v0.1.2-macOS-arm64.dmg
Coding-Wife-v0.1.2-macOS-arm64.dmg.sha256
Coding-Wife-v0.1.2-Windows-x64-setup.exe
Coding-Wife-v0.1.2-Windows-x64-setup.exe.sha256
Coding-Wife-v0.1.2-Linux-x64.deb
Coding-Wife-v0.1.2-Linux-x64.deb.sha256
Coding-Wife-v0.1.2-Linux-x64.AppImage
Coding-Wife-v0.1.2-Linux-x64.AppImage.sha256
```

Download all eight draft assets into a clean directory and verify the exact bytes:

```bash
shasum -a 256 --check Coding-Wife-v0.1.2-*.sha256
```
