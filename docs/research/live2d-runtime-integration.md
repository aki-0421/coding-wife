...
本書は `../requirements/live2d-companion.md`、`../screen-design/S-002_coding-workspace.md`、`../screen-design/S-005_app-settings-diagnostics.md`、`../../PRODUCT.md`、`../../DESIGN.md` を実装可能な契約へ落とした補足調査である。競合時は Approved の要件・画面設計を優先する。
