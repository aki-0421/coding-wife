...
fail() {
  ...
  case "$APP_FAILURE_INNER:$APP_FAILURE_CAUSE" in
    APP_BUILD_FAILED:BUILD_STORAGE_EXHAUSTED|APP_BUILD_FAILED:BUILD_PROCESS_TERMINATED|APP_BUILD_FAILED:RUST_LINK_FAILED|APP_BUILD_FAILED:RUST_COMPILE_FAILED|APP_BUILD_FAILED:FRONTEND_BUILD_FAILED|APP_BUILD_FAILED:TAURI_BUNDLE_FAILED|APP_BUILD_VERIFY_FAILED:APP_*)
