...
const en = {
  ...
  reasoningCycleHint: "Increase reasoning level · wraps back to Off",
  fastMode: "Fast mode",
  fastModeUnavailable: "Fast mode is unavailable for this model",
  goalsMode: "Set instruction as goal",
  planMode: "Plan mode",
  goalInstructionRequired:
    "Goals requires an instruction between 1 and 4,000 characters.",
  send: "Send",
  stop: "Stop",
  commandSend: "⌘↵ send",
  ...
  contextView: {
    ...
    saveCharacter: "Save character settings",
    ...
    loadingProject: "Loading project context",
    loadingCharacter: "Loading character context",
    unsaved: "Unsaved",
...
const ja: typeof en = {
  ...
  reasoningCycleHint: "推論強度を一段上げる · 最高値の次はオフ",
  fastMode: "Fastモード",
  fastModeUnavailable: "このモデルではFastモードを利用できません",
  goalsMode: "指示をGoalに設定",
  planMode: "Planモード",
  goalInstructionRequired: "Goalsには1〜4,000文字の指示が必要です。",
  send: "送信",
  stop: "停止",
  commandSend: "⌘↵ 送信",
  ...
  contextView: {
    ...
    loadingProject: "プロジェクトコンテキストを読込中",
    loadingCharacter: "キャラクターコンテキストを読込中",
    unsaved: "未保存",
